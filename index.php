        ...
        <div class="row">
          <div class="col-lg-7 mx-auto order-lg-2 align-self-center">
            <div class="site-block-cover-content text-center">
              ...
              <p>
                <a href="shopnew.php" class="btn btn-primary px-5 py-3">Shop Now</a>
              </p>
            </div>
          </div>
        </div>
      ...
      <div class="container">
        ...
        <div class="row mt-5">
          <div class="col-12 text-center">
            <a href="shopnew.php" class="btn btn-primary px-4 py-3">View All Products</a>
          </div>
        </div>
      </div>
    </div>
        ...
        <div class="row">
          <div class="col-md-12 block-3 products-wrap">
            <div class="nonloop-block-3 no-direction owl-carousel">
              ...
              <div class="testimony">
                <blockquote>
                  <img src="images/samu.jpg" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
              ...
              <div class="testimony">
                <blockquote>
                  <img src="images/manu.jpg" alt="Image" class="img-fluid w-25 mb-4 rounded-circle">
