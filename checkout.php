        ...
        <div class="row mb-5">
          <div class="col-md-12">
            <div class="bg-light rounded p-3">
              <p class="mb-0">Returning customer? <a href="pharmacyloginpage.php" class="d-inline-block">Click here</a> to login</p>
            </div>
          </div>
        </div>
        <div class="row">
...
?>
                    <tbody>
                      <tr>
                        <td><?php echo $product1["code"]; ?> <strong class="mx-2">x</strong> <?php echo $product1['quantity'];?></td>
...
?>
                      <tr>
                        ...
                        <td class="text-black"><?php echo "$".$total_price; ?></td>
                      </tr>
					  
                      <tr>
                        <td class="text-black font-weight-bold"><strong>Order Total</strong></td>
                        <td class="text-black font-weight-bold"><strong><?php echo "$".$total_price; ?></strong></td>
                      </tr>
                    </tbody>
                  </table>
<?php }?>
