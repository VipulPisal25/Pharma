...
$result = mysqli_query($conn,"select * from add_product where categary='c'");
if(mysqli_query($conn,"select * from add_product where name='$categary'"))
{echo "  ;;;;;;;;connect";}
else{ echo "not connect";}
echo "select * from add_product where categary='c'";
...
<?php
		...
		$res=mysqli_query($conn,"select * from add_product where categary='c'");
