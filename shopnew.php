...
$result = mysqli_query($conn,"select * from add_product where name='$code'");
if(mysqli_query($conn,"select * from add_product where name='$code'"))
{echo "  ;;;;;;;;connect";}
else{ echo "not connect";}
//echo "select * from add_product where name='$code'";
...
<?php
		...
		<!--<<div class="container">
            ...
            <p class="price"> Rs.<?php echo $row["mrp"];?></p>
			<p class="price">MF Date <?php echo $row["mfg"];?></p>
			
			<p class="price">Exp Date <?php echo $row["exp"];?></p>
			<p>
            <input type='text' class="form-control" name='quantity' value="" /></p>
