      ...
      <div class="container">
        <div class="d-flex align-items-center justify-content-between">
          ...
          <div class="icons">
		    ...
		    <a href="#" ><span class="icon-user margin-left"> Profile  </span></a>
            <a href="pharmacylogin.php" ><span class="icon-lock">   Log-out</span></a>
            ...
            <div class="block-38 text-center">
              <div class="block-38-img">
                <div class="block-38-header">
                  <img src="" alt="Image placeholder" class="mb-4">
                  <h3 class="block-38-heading h4">XYZ</h3>
