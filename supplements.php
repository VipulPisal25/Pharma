...
$result = mysqli_query($conn,"select * from add_product where categary='a'");
if(mysqli_query($conn,"select * from add_product where name='$categary'"))
{echo "  ;;;;;;;;connect";}
else{ echo "not connect";}
echo "select * from add_product where categary='a'";
...
<?php
		...
		$res=mysqli_query($conn,"select * from add_product where categary='a'");
